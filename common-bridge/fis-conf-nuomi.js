...
fis.config.merge({
    ...
    deploy: {
        remote: [{
            ...
            from: '/',
            subOnly: true,
            to: '/home/lv/webroot/event/s/728_promo_m/',
...
fis.config.set('roadmap.path', [{
    ...
    url: '/event/s/728_promo_m/static/pkg/$1'
}, {
    reg: /^\/page\/(.*\.*)$/i,
    isMod: true,
    release: '/$1',
    url: '/event/s/728_promo_m/$1'
}, {
    reg: /^\/lib\/(.*\.js)$/i,
    //非组件化
    isMod: false,
    ...
    url: '/event/s/728_promo_m/static/lib/$1'
}, {
    ...
    url: '/event/s/728_promo_m/static/modules/$1/$1' + '.js'
}, {
    //modules目录下的其他文件
    reg: /^\/modules\/(.*)\.(js)$/i,
    //是组件化的，会被jswrapper包装
    ...
    url: '/event/s/728_promo_m/static/modules/$1' + '.js'
}, {
    //widgets
    reg: /^\/widgets\/(.*)\.(js)$/i,
    //是组件化的，会被jswrapper包装
    ...
    url: '/event/s/728_promo_m/static/widgets/$1' + '.js',
}, {
    reg: /^\/widgets\/(.*)\.(?:css|less)$/i,
    release: '/static/widgets/$1' + '.css',
    url: '/event/s/728_promo_m/static/widgets/$1' + '.css',
}, {
    //图片
    reg: /^\/widgets\/(.*\.(?:png|gif|webp|jpg))$/i,
    isMod: false,
    release: '/static/widgets/$1',
    url: '/event/s/728_promo_m/static/widgets/$1'
}, {
    reg: /^\/widgets\/(.*)\.(?:html)$/i,
    release: '/static/widgets/$1' + '.html',
    url: '/event/s/728_promo_m/static/widgets/$1' + '.html',
}, {
    reg: /^\/widgets\/(.*)\.(?:json)$/i,
    release: '/static/widgets/$1' + '.json',
    url: '/event/s/728_promo_m/static/widgets/$1' + '.json',
}, {
    reg: /^\/widgets\/(.*)\.(eot|svg|ttf|woff)$/i,
    release: '/static/widgets/$1' + '.$2',
    url: '/event/s/728_promo_m/static/widgets/$1' + '.$2',
    useDomain: false
}, {
    //其他css文件
    reg: "**.css",
