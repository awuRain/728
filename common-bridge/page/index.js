...
require('./lazyelement/lazyelement.js');
var Bridge = require('Bridge');
var Juicer = require('juicer');
var pblog = require('./pblog-webapp/pblog-webapp.js');
var CountDown = require('./countdown.js');
var lite = require('./lite/lite.js');
...
var App = {
            ...
            data: $.extend({}, {
                ...
                list: {
                    ...
                    html: me.createTicketList({
                        type: me.baseOrder_Key[_settings.id]['push2'],
                        // direction: 'vertical',
    ...
    events: function() {
        var me = this,
            ...
            loadTimes = 0,
            $targetPlaceholder = $('.J-placeholder').eq(1),
            _scrollTimer = null,
            $win = $(window),
