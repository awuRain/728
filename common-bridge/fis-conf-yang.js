...
fis.config.merge({
    ...
    deploy: {
        remote: [{
            ...
            from: '/static',
            subOnly: true,
            to: '/home/lv/webroot/event/s/728_promotion_m_yang/static',
            exclude: /.*\.(?:svn|cvs|tar|rar|psd).*/
        }, {
            receiver: deploy + '/static/receiver.php',
            from: '/page',
            subOnly: true,
            to: '/home/lv/webroot/event/s/728_promotion_m_yang/',
            exclude: /.*\.(?:svn|cvs|tar|rar|psd).*/
        }]
    }
});
...
fis.config.set('roadmap.path', [{
    ...
    url: '/event/s/728_promotion_m_yang/static/pkg/$1'
}, {
    //图片
    reg: /^\/page\/(.*\.(?:png|gif|webp|jpg))$/i,
    isMod: false,
    release: '/page/$1',
    url: '/event/s/728_promotion_m_yang/$1'
}, {
    reg: /^\/page\/(.*)\.(?:css|less)$/i,
    release: '/page/$1' + '.css',
    url: '/event/s/728_promotion_m_yang/$1' + '.css',
}, {
    //page目录下的其他文件
    reg: /^\/page\/(.*)\.(js)$/i,
    //是组件化的，会被jswrapper包装
    ...
    id: '$1',
    release: '/page/$1' + '.js',
    url: '/event/s/728_promotion_m_yang/$1' + '.js'
}, {
    reg: /^\/lib\/(.*\.js)$/i,
    //非组件化
    isMod: false,
    ...
    url: '/event/s/728_promotion_m_yang/static/lib/$1'
}, {
    ...
    url: '/event/s/728_promotion_m_yang/static/modules/$1/$1' + '.js'
}, {
    //modules目录下的其他文件
    reg: /^\/modules\/(.*)\.(js)$/i,
    //是组件化的，会被jswrapper包装
    ...
    url: '/event/s/728_promotion_m_yang/static/modules/$1' + '.js'
}, {
    //widgets
    reg: /^\/widgets\/(.*)\.(js)$/i,
    //是组件化的，会被jswrapper包装
    ...
    url: '/event/s/728_promotion_m_yang/static/widgets/$1' + '.js',
}, {
    reg: /^\/widgets\/(.*)\.(?:css|less)$/i,
    release: '/static/widgets/$1' + '.css',
    url: '/event/s/728_promotion_m_yang/static/widgets/$1' + '.css',
}, {
    //图片
    reg: /^\/widgets\/(.*\.(?:png|gif|webp|jpg))$/i,
    isMod: false,
    release: '/static/widgets/$1',
    url: '/event/s/728_promotion_m_yang/static/widgets/$1'
}, {
    reg: /^\/widgets\/(.*)\.(?:html)$/i,
    release: '/static/widgets/$1' + '.html',
    url: '/event/s/728_promotion_m_yang/static/widgets/$1' + '.html',
}, {
    reg: /^\/widgets\/(.*)\.(?:json)$/i,
    release: '/static/widgets/$1' + '.json',
    url: '/event/s/728_promotion_m_yang/static/widgets/$1' + '.json',
}, {
    reg: /^\/widgets\/(.*)\.(eot|svg|ttf|woff)$/i,
    release: '/static/widgets/$1' + '.$2',
    url: '/event/s/728_promotion_m_yang/static/widgets/$1' + '.$2',
    useDomain: false
}, {
    //其他css文件
    reg: "**.css",
